...
// ===== Time config =====
const long gmtOffset_sec = 3600;     // UTC+1 (Switzerland)
...
String getTimestamp() {
  ...
  char finalBuffer[30];
  sprintf(finalBuffer, "%s.%03lu", buffer, ms);
...
void handleDownload() {
  String s = "timestamp,time_ms,current_mA,voltage_V,power_W,energy_J\n";
